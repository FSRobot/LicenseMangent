...
using LicenseManagement.ViewModels.Windows;
using LicenseManagement.Views.Pages;
using LicenseManagement.Views.Windows;
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton(factory.CreateDbContext(Array.Empty<string>()));
